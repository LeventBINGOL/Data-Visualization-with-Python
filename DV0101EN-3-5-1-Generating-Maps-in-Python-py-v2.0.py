...
### type your answer here
# create a Stamen Toner map of the world centered around Mexico
...
df_incidents=pd.read_csv('Police_ment_Incidents_-_Previous_Year__2016_.csv')
...
get_ipython().system('wget --quiet https://ibm.box.com/shared/static/cto2qv7nx6yq19logfcissyy4euo8lho.json -O world_countries.json')
