...
# generate histogram overlapping
# un-stacked histogram
...
plt.title('Histogram of Immigration fromGreece, Albania, and Bulgaria from 1980 - 2013')
plt.ylabel('Number of Years')
plt.xlabel('Number of Immigrants')
...
plt.xlabel('Number of Immigrants')
plt.title('Top 15 Contries Contributing to the Immigration to Canada between 1980 - 2013')
...
df_top15.plot(kind='barh', figsize=(10, 6), rot=0) 

plt.xlabel('Number of Immigrants')
plt.ylabel('Countries')
plt.title('Total Immigrants from top 15 countries to Canada from 1980 to 2013')
